# ============================================================
# FULL PREPROCESSING + EXPANDED EDA + NPZ EXPORT
# ============================================================
...
# ============================================================
# 6. TRAIN/VAL SPLITS (75/15/15)
# ============================================================
X_train, X_temp, y_train, y_temp = train_test_split(
    X_train_raw, y_train_raw, test_size=0.25,
    random_state=42, stratify=y_train_raw)

X_val, X_extra, y_val, y_extra = train_test_split(
    X_temp, y_temp, test_size=0.40,
...
# ============================================================
# 🔥 8. EDA VISUALIZATION FUNCTIONS (UPDATED WITH COLORS)
# ============================================================
